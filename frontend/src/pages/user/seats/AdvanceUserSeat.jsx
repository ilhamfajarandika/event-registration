...
export default function AdvanceUserSeat() {
          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="mt-8 grid sm:grid-cols-2 gap-5">
                <InfoPill title="Advance access" text="Seat nyaman dengan harga tetap worth." />
                <InfoPill title="Great view" text="Angle panggung tetap enak." />
