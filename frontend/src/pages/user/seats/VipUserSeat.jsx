...
export default function VipUserSeat() {
          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="mt-8 grid sm:grid-cols-2 gap-5">
                <InfoPill title="VIP experience" text="Area terbaik untuk ngerasain konser maksimal." />
                <InfoPill title="Fast entry" text="Masuk venue lebih praktis." />
